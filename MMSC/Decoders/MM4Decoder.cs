...
namespace MMSC.Decoders
{
    public class MM4Decoder
    {
        ...
        private static Dictionary<string, int> Headers = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        ...
        private static Dictionary<string, int> CharacterSets = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        ...
        private static Dictionary<string, int> WellKnownParameters = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        ...
        private static Dictionary<string, int> ContentTypes = new Dictionary<string, int>()
        ...
        public static MMSMessageModel Parse(MimeMessage message)
        {
            ...
            try
            {
                ...
                //Data
                //string hexData = (message.Attachments.Count()+message.BodyParts.Count()).ToString("x2");
                ...
                foreach (var attachment in message.BodyParts)
                {
                    ...
                    int contentTypeCode;
                    if (ContentTypes.TryGetValue(attachment.ContentType.MimeType, out contentTypeCode))
                    {
                    ...
                    foreach (var parameter in attachment.ContentType.Parameters)
                    {
                        ...
                        if (WellKnownParameters.TryGetValue(parameter.Name, out parameterEncode))
                        {
                                ...
                                case 0x01: //Charset
                                    {
                                        ...
                                        int charsetCode;
                                        if (CharacterSets.TryGetValue(parameter.Value, out charsetCode))
                                        {
                    ...
                    foreach (var header in attachment.Headers)
                    {
                        ...
                        if (Headers.TryGetValue(header.Field, out headerCode))
                        {
                            switch (headerCode)
                            {
